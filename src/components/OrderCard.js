  ...
  return (
    <Card className="my-3">
      <Card.Header className="d-flex d-flex-column justify-content-around">
          <Card.Text className="text-start flex-fill">Order by: {user.firstName}</Card.Text>
        <Card.Text className="text-end">Date Ordered: {formatDate(order.createdOn)}</Card.Text> 
      </Card.Header>
      <Card.Body>
